    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.atn_direct_discover:
                ...
                mApp.mP2pMan.discoverPeers(mApp.mP2pChannel, new WifiP2pManager.ActionListener() {
                    ...
                    public void onFailure(int reasonCode) {
                    	...
                    	fragment.clearPeers();
                        Toast.makeText(WiFiDirectActivity.this, "Discovery Failed, Please Try Again... ", Toast.LENGTH_SHORT).show();
                    }
                });
                return true;
            ...
            case R.id.about:
            	...
            	Toast.makeText(this, "About Page under Construction.. Inconvenience Regretted!!!", Toast.LENGTH_LONG).show();
            ...
            case R.id.help:
            	...
            	Toast.makeText(this, "Help Page under Construction.. Inconvenience Regretted!!!", Toast.LENGTH_LONG).show();
            	return true;
